...
import * as mammoth from "mammoth"; // NEW: Import Mammoth for DOCX
...
// NEW: DOCX Extraction logic using Mammoth
...
async function generateQuiz({ notes, type, count, difficulty, topic }) {
  ...
  // UPDATED: Stricter prompt to ensure valid JSON and good distractors
...
5. Formatting: You MUST escape any double quotes inside your string values using a backslash (e.g., \\"quoted text\\"). Do NOT include trailing commas at the end of arrays or objects.
...
export default function QuizCraft() {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      // NEW: Added check for DOCX files
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              ...
              <div>
                <input
                  type="file"
                  accept=".pdf,.docx" // NEW: Added .docx support
